                ...
                <div class="tw-flex tw-gap-x-2">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('pengunjungs.export', 'excel') }}">Excel</a>
                            </li>
                                ...
                                <tr>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" onclick="edit(@js($pengunjung->id))"
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger"
                                                onclick="deleteData({{ $pengunjung->id }})" data-bs-toggle="modal"
                        ...
                        <div class="modal-body">
                            <form
                                ...
                                <div class="tw-col-span-8">
                                    ...
                                    <input type="text"
                                        class="form-control @error('no_ktp') is-invalid @enderror dark:!tw-bg-gray-800"
                                ...
                                <div class="tw-col-span-5">
                                    ...
                                    <select
                                        class="form-select @error('jenis_kelamin') is-invalid @enderror dark:!tw-bg-gray-800"
                                ...
                                <div class="tw-col-span-7">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tgl_berkunjung', '') }}" required>
