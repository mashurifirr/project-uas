                ...
                <div class="tw-flex tw-gap-x-2">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('tempat_wisatas.export', 'excel') }}">Excel</a>
                            </li>
            ...
            <div class="tw-w-full tw-overflow-y-auto">
                                ...
                                <tr>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" onclick="edit(@js($tempat_wisata->id))"
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger"
                                                onclick="deleteData({{ $tempat_wisata->id }})" data-bs-toggle="modal"
                                    ...
                                    <td>
                                      @if ($tempat_wisata->gambar)
                                          <img class="tw-max-w-64 tw-w-auto " src="storage/{{ $tempat_wisata->gambar }}"
                                              alt="" title="" />
                                      @endif</td>
                                    <td>
                                        @php
                                        ...
                                        <img class="tw-mx-auto"
                                            src="https://api.qrserver.com/v1/create-qr-code/?data={!! urlencode($dataQR) !!}&amp;size=150x150"
                                            alt="" title="" />
                                    </td>
                ...
                @else
                    @if (request()->has('search'))
                        <div class="tw-w-full tw-flex tw-justify-center tw-px-4 tw-py-8">
                            <h1 class="tw-font-bold tw-text-lg">Data Tidak Ditemukan</h1>
                        </div>
                    @else
                        <div class="tw-w-full tw-flex tw-justify-center tw-px-4 tw-py-8">
                            <h1 class="tw-font-bold tw-text-lg">Tidak ada data</h1>
                        </div>
                    @endif
                @endif
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 id="title"
                                class="dark:tw-text-white tw-text-2xl tw-font-semibold tw-text-gray-900">
                                Tempat Wisata Baru
                            </h1>
                        </div>
                        <div class="modal-body">
                            <form
                                ...
                                <div class="tw-col-span-4">
                                    ...
                                    <input type="text"
                                        class="form-control @error('kode') is-invalid @enderror dark:!tw-bg-gray-800"
                                        id="kode" name="kode" value="{{ old('kode', $kode ?? '') }}"
                                        required>
                                    @error('kode')
                                ...
                                <div class="tw-col-span-12">
                                    ...
                                    <input type="text"
                                        class="form-control @error('nama') is-invalid @enderror dark:!tw-bg-gray-800"
                                ...
                                <div class="tw-col-span-6">
                                    ...
                                    <input type="text"
                                        ...
                                        id="tahun_buka" name="tahun_buka" value="{{ old('tahun_buka', '') }}"
                                        required>
                                    @error('tahun_buka')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="tw-col-span-6">
                                    ...
                                    <input type="time"
                                        class="form-control @error('jam_buka') is-invalid @enderror dark:!tw-bg-gray-800"
                                ...
                                <div class="tw-col-span-6">
                                    ...
                                    <input type="time"
                                        class="form-control @error('jam_tutup') is-invalid @enderror dark:!tw-bg-gray-800"
                                ...
                                <div class="tw-col-span-12">
                                    ...
                                    <input type="file"
                                        class="form-control @error('gambar') is-invalid @enderror dark:!tw-bg-gray-800"
                                        id="gambar" name="gambar" required accept="image/*">
                                    @error('gambar')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="tw-col-span-12 tw-flex tw-flex-row-reverse tw-gap-x-4">
                                    <button type="submit"
                                        class="btn btn-primary tw-mt-6 tw-flex tw-items-center tw-gap-x-2">
